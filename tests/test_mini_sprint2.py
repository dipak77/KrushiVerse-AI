...
def test_sprint2_markers():
    ...
    assert __sprint__ in {"S2", "S3", "S4", "S5", "S6", "S7", "S8", "S9", "S10", "S11", "S12", "S13", "S14", "S15"}
    assert __feature_phase__ in {"FP-1", "FP-2", "FP-3", "FP-4", "FP-5", "FP-5b", "FP-6", "FP-7", "E5-eval", "E5-quant", "FP-8"}
